...
TD.debug.log = function (info) {
    ...
    if (!domWrap) {
        ...
        domWrap.setAttribute('id', 'log');
        document.body.appendChild(domWrap);
        domWrap.style.position = 'absolute';
        domWrap.style.zIndex = '9999';
        domWrap.style.left = '10px';
        domWrap.style.top = '10px';
        domWrap.style.color = '#fff';
        domWrap.style.backgroundColor = 'rgba(0,0,0,0.6)';
        domWrap.style.fontSize = '13px';
    }
    if (domWrap.children.length > 20) {
