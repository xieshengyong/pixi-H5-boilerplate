    ...
    (function (core) {
        ...
        var DeformTimeline = (function (_super) {
            ...
            DeformTimeline.prototype.apply = function (skeleton, lastTime, time, firedEvents, alpha, blend, direction) {
                ...
                if (!(slotAttachment instanceof core.VertexAttachment) || !(slotAttachment.deformAttachment == this.attachment)) { return; }
        ...
        var AnimationState = (function () {
                ...
                for (var i_16 = 0, n_1 = tracks.length; i_16 < n_1; i_16++) {
                    ...
                    if ((i_16 == 0 && mix == 1) || blend == core.MixBlend.add) {
                        for (var ii = 0; ii < timelineCount; ii++) {
                            ...
                            if (timeline instanceof core.AttachmentTimeline) { this.applyAttachmentTimeline(timeline, skeleton, animationTime, blend, true); } else { timeline.apply(skeleton, animationLast, animationTime, events, mix, blend, core.MixDirection.mixIn); }
                        }
                    } else {
            ...
            AnimationState.prototype.applyMixingFrom = function (to, skeleton, blend) {
                ...
                if (blend == core.MixBlend.add) {
                    for (var i = 0; i < timelineCount; i++) { timelines[i].apply(skeleton, animationLast, animationTime, events, alphaMix, blend, core.MixDirection.mixOut); }
                } else {
                    ...
                    for (var i = 0; i < timelineCount; i++) {
                        ...
                        if (timeline instanceof core.RotateTimeline) { this.applyRotateTimeline(timeline, skeleton, animationTime, alpha, timelineBlend, timelinesRotation, i << 1, firstFrame); } else if (timeline instanceof core.AttachmentTimeline) { this.applyAttachmentTimeline(timeline, skeleton, animationTime, timelineBlend, attachments); } else {
                            core.Utils.webkit602BugfixHelper(alpha, blend);
                            if (drawOrder && timeline instanceof core.DrawOrderTimeline && timelineBlend == core.MixBlend.setup) { direction = core.MixDirection.mixIn; }
            ...
            AnimationState.prototype.applyAttachmentTimeline = function (timeline, skeleton, time, blend, attachments) {
                ...
                if (time < frames[0]) {
                    if (blend == core.MixBlend.setup || blend == core.MixBlend.first) { this.setAttachment(skeleton, slot, slot.data.attachmentName, attachments); }
                } else {
                    var frameIndex;
                    if (time >= frames[frames.length - 1]) { frameIndex = frames.length - 1; } else { frameIndex = core.Animation.binarySearch(frames, time) - 1; }
            ...
            AnimationState.prototype.computeHold = function (entry) {
                ...
                outer: for (var i = 0; i < timelinesCount; i++) {
                    ...
                    if (!propertyIDs.add(id)) { timelineMode[i] = AnimationState.SUBSEQUENT; } else if (to == null || timeline instanceof core.AttachmentTimeline || timeline instanceof core.DrawOrderTimeline ||
                    ...
                    case core.TransformMode.NoScaleOrReflection: {
                        ...
                        if (this.data.transformMode == core.TransformMode.NoScale &&
                            (pa * pd - pb * pc < 0) != (Bone.yDown
                                ...
                                : (this.skeleton.scaleX < 0 != this.skeleton.scaleY < 0))) { s = -s; }
                    ...
                    for (var ii = 0, nn = input.readInt(true); ii < nn; ii++) {
                        ...
                        switch (timelineType) {
                            ...
                            case SkeletonBinary.BONE_SHEAR: {
                                var timeline = void 0;
                                var timelineScale = 1;
                                if (timelineType == SkeletonBinary.BONE_SCALE) { timeline = new core.ScaleTimeline(frameCount); } else if (timelineType == SkeletonBinary.BONE_SHEAR) { timeline = new core.ShearTimeline(frameCount); } else {
                    ...
                    for (var ii = 0, nn = input.readInt(true); ii < nn; ii++) {
                        ...
                        for (var iii = 0, nnn = input.readInt(true); iii < nnn; iii++) {
                            ...
                            for (var frameIndex = 0; frameIndex < frameCount; frameIndex++) {
                                ...
                                if (end == 0) { deform = weighted ? core.Utils.newFloatArray(deformLength) : vertices; } else {
                        ...
                        for (var timelineName in boneMap) {
                            ...
                            if (timelineName === 'rotate') {
                                ...
                                if (timelineName === 'scale') {
                                    ...
                                    defaultValue = 1;
                                } else if (timelineName === 'shear') { timeline = new core.ShearTimeline(timelineMap.length); } else {
...
(function (pixi_spine) {
    ...
    console.log('PIXI', Object.assign(PIXI));
    // console.log('PIXI.spine', Object.assign(PIXI.spine));
    console.log('pixi_spine', Object.assign(pixi_spine));
...
(function (pixi_spine) {
    ...
    var AtlasParser = (function () {
        ...
        AtlasParser.use = function (resource, next) {
            ...
            var metadataAtlasSuffix = metadata.spineAtlasSuffix || '.ttf';
