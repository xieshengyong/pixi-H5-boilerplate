...
export class PixiJsSpineTest2 extends View {
    constructor () {
        super();
        ...
        new PIXI.Loader()
            // @ts-ignore
            .add({ name: 'sc1-ani1-test', url: Config.sheetDirPath + 'sc1-ani1-test.json', metadata: { spineAtlasSuffix: '.atlas' } })
    ...
    private initSpine (loaderRes: any) {
        // @ts-ignore
        var animation2 = new PIXI.spine.Spine(loaderRes['sc1-ani1-test'].spineData);
